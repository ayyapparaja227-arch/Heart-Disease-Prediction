...
# =============================================
st.set_page_config(
    page_title="Heart Disease Prediction | Ayyapparaja",
    page_icon="🫀",
    layout="wide",
...
with st.sidebar:
    ...
    st.caption("**Developer:** Ayyapparaja")
...
if model:
    ...
    with tab_info:
        ...
        st.info("🎓 **Academic Project 2026** • Developed by **Ayyapparaja** for Advanced Data Science and Machine Learning coursework.")
...
st.markdown("""
<div class="footer">
    © 2026 Ayyapparaja • Heart Disease Prediction System • Framingham Model • v2.0.0
</div>
""", unsafe_allow_html=True)
